...
router.post('/create',permit([employeeRoles.Admin,employeeRoles.Storage_Keeper]), CreateStorageValidator,async (
    req: Request,
    res: Response,
    next: NextFunction
) => {
...
router.get('/display',permit([employeeRoles.Admin,employeeRoles.Storage_Keeper]), async (
    req: Request,
    res: Response,
    next: NextFunction
) => {
...
// EDIT USERS
router.put('/edit',permit([employeeRoles.Admin,employeeRoles.Storage_Keeper]), async (
    req: Request,
    res: Response,
    next: NextFunction
) => {
...
// DELETE USERS
router.delete('/delete',permit([employeeRoles.Admin,employeeRoles.Storage_Keeper]), async (
    req: Request,
    res: Response,
    next: NextFunction
) => {
...
router.post('/outForDelivery',permit([employeeRoles.Admin,employeeRoles.Storage_Keeper]), async (
    req: Request,
    res: Response,
    next: NextFunction
) => {
