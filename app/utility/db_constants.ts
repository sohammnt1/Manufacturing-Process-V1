...
export const employeeRoles = convertArrayToObject(populatedVariableArray[0], "name")
export const furnaces = convertArrayToObject(populatedVariableArray[1], "name")
export const productTypes = convertArrayToObject(populatedVariableArray[2], "name")
export const storageRacks = convertArrayToObject(populatedVariableArray[3], "rackNumber")
